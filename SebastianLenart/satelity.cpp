...
QPointF Satelity::setDistance(double d, Planety *obiekt, bool pozycja) // przeciaz metode do planety i slonca slonce jako QPOint
{
    dystans=d;
    pozSat=pozycja;
    int poz=1;
...
void Satelity::setOwner(Planety* Ow)
{
    ...
    //    Owner->setTimer(10); mozan uruchomic tutaj timer jezeli nie udalo sie w konstruktorze PLanety!!!
}
